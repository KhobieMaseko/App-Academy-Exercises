...
let andSelect = function(arr, callback1, callback2) {
    // Use the `filter` method to create a new array with elements
    // ... that satisfy both callback conditions.
    return arr.filter((element) => callback1(element) && callback2(element));
};
