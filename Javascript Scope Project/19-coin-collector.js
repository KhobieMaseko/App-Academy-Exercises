...
function coinCollector(numCoins) {
  ...
  function collectCoin(coin) {
    ...
    if (coinsCollected.length === numCoins) {
      // If numCoins required are collected, return the array
      return coinsCollected;
    } else {
      // If numCoins are not yet collected, return a function for further collection
      return collectCoin;
    }
  }
